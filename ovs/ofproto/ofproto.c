...
void abnormal_detect(struct ofproto *p)
{
    ...
    {  
      ...
      fp=fopen("/home/iot_team/BF/data_recording.log","a+");
      ...
      {  
        if(p->data_counter==0)
          fp=fopen("/home/iot_team/BF/training.log","r");
        ...
        {
          p->writing=1;
          fp=fopen("/home/iot_team/BF/training.log","a+");
        ...
        { 
          ...
          fp = fopen("/home/iot_team/BF/lrd.log","a+");
          for (int i=0;i<p->data_counter;i++)
          {
             fprintf(fp,"%f\n",p->Data[i]->lrd);
          }
          ...
          fclose(fp);
          fp=fopen("/home/iot_team/BF/nor_training.log","a+");
          for(int i=0;i<p->data_counter;i++)
          {
     ...
     else 
      {
          ...
          //   p->lof_status=1;
          // else p->lof_status=0;
         // fp= fopen("/home/iot_team/BF/time_detect.log","a+");
